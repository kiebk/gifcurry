...
GIFCURRY_DISTRIBUTION_LINUX_COMMON="https://raw.githubusercontent.com/lettier/gifcurry/master/distribution/linux/common"
...
cd "$HOME/.icons"
wget "$GIFCURRY_DISTRIBUTION_LINUX_COMMON/gifcurry-icon.svg" -O "gifcurry-icon.svg"
cd "$HOME/.local/share/applications"
wget "$GIFCURRY_DISTRIBUTION_LINUX_COMMON/gifcurry.desktop" -O "gifcurry.desktop"
